...
SRC = os.path.join(ROOT, 'assets/source/animals-line.png')
OUT = os.path.join(ROOT, 'docs/design/pieces')
os.makedirs(OUT, exist_ok=True)
COLS=[(61,348),(395,684),(729,1016),(1063,1348)]
ROWS=[(63,356),(413,713)]
NAMES=[["lion","tiger","rooster","chick-a"],["elephant","chick-b","giraffe-a","giraffe-b"]]
BG,INK=243.0,48.0
PAD,SIZE=0.08,320
KEEP_INSET, KEEP_R = 14, 46   # strip the rounded-rect frame, corner arcs included
